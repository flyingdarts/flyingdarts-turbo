            ...
            .GetServiceProvider(
                (services, configuration) =>
                {
                    ...
                    Flyingdarts
                        ...
                        .Infrastructure
                        .ServiceFactory
                        .ConfigureMediatR(services, typeof(OnDefaultCommand));
                    Flyingdarts
                        .Lambda
                        .Core
                        .Infrastructure
                        .ServiceFactory
                        .ConfigureMediatR(services, typeof(OnDisconnectCommand));
                    ...
                    services.AddSingleton(
                        provider =>
                            provider
                                .GetRequiredService<Flyingdarts.Meetings.Service.Factories.DyteApiClientFactory>()
                                .GetClient()
                    );
                    ...
                    >();
                    services.AddSingleton<
                        Flyingdarts.DynamoDb.Service.IDynamoDbService,
                        Flyingdarts.DynamoDb.Service.DynamoDbService
                    >();
