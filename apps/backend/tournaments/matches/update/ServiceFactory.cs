...
public static class ServiceFactory
{
    ...
    public static ServiceProvider GetServiceProvider()
    {
        ...
        services.AddValidatorsFromAssemblyContaining<UpdateTournamentMatchCommandValidator>();

        // Register MediatR and register services from the assembly containing CreateX01ScoreCommand.
        services.AddMediatR(cfg => cfg.RegisterServicesFromAssembly(typeof(UpdateTournamentMatchCommand).Assembly));
