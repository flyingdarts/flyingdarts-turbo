...
export const loadFriendRequests = createAction(
...
export const loadFriendRequestsFailure = createAction(
  FriendsActions.LoadFriendRequestsFailure,
  props<{ error: any }>()
);
...
export const removeFriendSuccess = createAction(
  FriendsActions.RemoveFriendSuccess,
  props<{ friendId: string }>()
);
...
export const sendFriendRequest = createAction(
  FriendsActions.SendFriendRequest,
  props<{ friendId: string }>()
);
