...
public interface IDynamoDbService
{
    ...
    Task<User> ReadUserByAuthProviderUserIdAsync(string authProviderUserId, CancellationToken cancellationToken);
    Task<User?> ReadUserByConnectionIdAsync(string connectionId, CancellationToken cancellationToken);
